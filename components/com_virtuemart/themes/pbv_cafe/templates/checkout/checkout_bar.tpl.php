...
echo '<table style="background: url('. VM_THEMEURL .'images/checkout/checkout'. $step_count.'_'.$current_step .'.png) top center; background-repeat: no-repeat;width:710px;height:115px;text-align:center;" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>';
