...
define('CVS_REVISION', '$RCSfile$ - $Revision: 38495 $');
...
if ($_REQUEST['do'] == 'stylegenerator' AND !(is_browser('ie') AND !is_browser('ie', 7)))
{
	...
	$stylegeneratorjs =
		...
		<script type="text/javascript" src="../clientscript/jquery/jquery-1.3.min.js?v=' . SIMPLE_VERSION . '"></script>
...
if ($_REQUEST['do'] == 'upload')
{
	...
	{
		print_cp_redirect("template.php?" . $vbulletin->session->vars['sessionurl'] . "do=rebuild");
	}
}
