...
abstract class vBCms_Widget
{
	 ...
	 */
	public function create($package, $class, $widget)
	{
	...
	protected function assertWidget()
	{
		...
		{
			throw (new vBCms_Exception_Widget('Could not load widget \'' . get_class($this) . '\' with id \'' . htmlspecialchars($this->widgetid) . '\''));
		}
	}
	...
	{
		throw (new vBCms_Exception_Widget('Config view requested from widget \'' . htmlspecialchars($this->title) . '\' but getConfigView() is undefined'));
	}
	...
	{
		throw (new vBCms_Exception_Widget('Config Editor view requested from widget \'' . htmlspecialchars($this->title) . '\' but getConfigView() is undefined'));
	}
