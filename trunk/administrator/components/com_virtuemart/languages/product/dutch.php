...
$langvars = array (
        'CHARSET' => 'ISO-8859-1',
        'PHPSHOP_MODULE_LIST_ORDER' => 'Lijstvolgorde',
        ...
        'PHPSHOP_PRODUCT_FORM_ITEM_DIM_WEIGHT_LBL' => 'Item afmetingen en gewicht',
        ...
        'PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP1' => 'Type een tekst welke getoond wordt aan de klant op de product flypage.<br />Bijvoorbeeld: 24u, 48 uur , 3 - 5 dagen, Op bestelling.....',
        ...
        'VM_DISPLAY_LINK_TO_CHILD' => 'Link naar het onderliggende product in de lijst',
        'VM_DISPLAY_INCLUDE_PRODUCT_TYPE' => 'Include Product Type With Child',
        'VM_DISPLAY_USE_LIST_BOX' => 'Gebruik de List box voor onderliggende producten',
        'VM_DISPLAY_LIST_STYLE' => 'Type lijst',
        'VM_DISPLAY_USE_PARENT_LABEL' => 'Gebruik dezelfde instelling als de bovenliggende producten:',
        'VM_DISPLAY_LIST_TYPE' => 'Lijst:',
        'VM_DISPLAY_QUANTITY_LABEL' => 'Hoeveelheid:',
        'VM_DISPLAY_QUANTITY_DROPDOWN_LABEL' => 'Drop Down Box waardes',
        'VM_DISPLAY_CHILD_DESCRIPTION' => 'Geef beschrijving onderliggende producten weer',
        ...
        'PHPSHOP_DISPLAY_RADIOBOX' => 'Gebruik Radio Box',
        'PHPSHOP_PRODUCT_FORM_ITEM_DISPLAY_LBL' => 'Geef opties weer',
        'PHPSHOP_DISPLAY_USE_PARENT' => 'Override Child products Display Values and use parents',
        'PHPSHOP_DISPLAY_NORMAL' => 'Standaard hoeveelheid box',
        'PHPSHOP_DISPLAY_HIDE' => 'Verberg hoeveelheid box',
        'PHPSHOP_DISPLAY_DROPDOWN' => 'Gebruik dropdown box',
        'PHPSHOP_DISPLAY_CHECKBOX' => 'Gebruik check box',
        'PHPSHOP_DISPLAY_ONE' => 'Één voeg toe aan winkelwagen knop',
        'PHPSHOP_DISPLAY_MANY' => 'Winkelwagen knop voor ieder onderliggend product',
        'PHPSHOP_DISPLAY_START' => 'Beginwaarde',
        'PHPSHOP_DISPLAY_END' => 'Eindwaarde',
        'PHPSHOP_DISPLAY_STEP' => 'Trede/Step Value',
        ...
        'VM_FILES_LIST_ROLE' => 'Taakoverzicht/Role',
        ...
        'VM_PRODUCT_CLONE_OPTIONS_TAB' => 'Kloon product opties',
        'VM_PRODUCT_CLONE_OPTIONS_LBL' => 'Kloon tevens deze onderliggende items',
