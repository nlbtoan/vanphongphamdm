...
$langvars = array (
        ...
        'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_TEXT' => 'Tekst email',
...
Wanneer niet aangevinkt dan is de prijslabel zoals gewoonlijk <strong>Prijs: $xx.xx</strong>',
        ...
        'PHPSHOP_ADMIN_CFG_USER_REGISTRATION_SETTINGS' => 'Gebruiker registratie instellingen',
        ...
        'VM_FIELDMANAGER_NAME' => 'Naam veld',
        'VM_FIELDMANAGER_TITLE' => 'Titel veld',
        'VM_FIELDMANAGER_TYPE' => 'Veld type',
        'VM_FIELDMANAGER_REQUIRED' => 'Benodigd',
        'VM_FIELDMANAGER_PUBLISHED' => 'gepubliceerd',
        'VM_FIELDMANAGER_SHOW_ON_REGISTRATION' => 'Geef weer in registratie formulier',
        'VM_FIELDMANAGER_SHOW_ON_ACCOUNT' => 'Geef weer in account onderhoud',
        'VM_USERFIELD_FORM_LBL' => 'Wijzig of doe een toevoeging aan de gebruikers velden',
        'VM_BROWSE_ORDERBY_DEFAULT_FIELD_LBL' => 'Standaard product rangschikking',
        ...
        'VM_BROWSE_ORDERBY_FIELDS_LBL' => 'Beschikbare rangschik velden',
        'VM_BROWSE_ORDERBY_FIELDS_LBL_TIP' => 'Kies de rangschik velden voor de browse pagina. Ieder veld definieerd een bepaalde rangschik methode voor de product browse pagina. Wanneer u ze allemaal selecteerd, dan zal het Order-By-Form niet worden weergegeven.',
        'VM_GENERALLY_PREVENT_HTTPS' => 'Voorkom zoveel als mogelijk https connecties?',
        'VM_GENERALLY_PREVENT_HTTPS_TIP' => 'Indien aangevinkt, zal de klant doorverwezen worden naar <strong>http</strong> URLs wanneer deze zich op pagina/s bevindt waar het niet nodig is https te gebruiken.',
        'VM_MODULES_FORCE_HTTPS' => 'Winkel pagina/s waarvoor het noodzakelijk is https te gebruiken',
        'VM_MODULES_FORCE_HTTPS_TIP' => 'Hier kunt u een door een komma gescheiden lijst ingeven van winkel core modules (Zie "Admin" => "List Modules"), waarvoor een https connectie moet gebruikt worden.',
        'VM_SHOW_REMEMBER_ME_BOX' => 'Laat de "Herinner mij" checkbox zien bij het inloggen?',
        'VM_SHOW_REMEMBER_ME_BOX_TIP' => 'Wanneer aangevinkt, zal de checkbox "herinner mij" zien bij checkout. Not recommended when using shared ssl, because the customer could choose not to get a user cookie -  but that user cookie is required to keep the user logged in on both domains.',
        'VM_ADMIN_CFG_REVIEW_MINIMUM_COMMENT_LENGTH' => 'Minimum lengte commentaar',
        'VM_ADMIN_CFG_REVIEW_MINIMUM_COMMENT_LENGTH_TIP' => 'Dit is het aantal leestekens die minimaal moeten worden ingegeven voordat een klant de review kan toevoegen.',
        'VM_ADMIN_CFG_REVIEW_MAXIMUM_COMMENT_LENGTH' => 'Maximum lengte commentaar',
...
',
        'VM_ADMIN_SHOW_EMAILFRIEND' => 'Geef email symbool weer?',
...
Klanten kunnen en hoeven zich bij deze optie niet te registreren.',
        ...
        'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_FLEX' => 'Flexibele verzending. Vaste verzendkosten to set base value of order with percentage of total sale above base value',
        ...
        'VM_USER_FORM_NOCONTACTDETAILS_2' => 'Zie \'Components -> Contact -> Manage Contacts\' voor meer details.',
        ...
        'VM_USER_FORM_CONTACTDETAILS_CHANGEBUTTON' => 'Verander contact informatie',
    ...
    'VM_ADMIN_CFG_LOGFILE_NAME_EXPLAIN'  => 'Path naar logbestand. Moet bereikbaar en beschrijfbaar zijn.',
    'VM_ADMIN_CFG_LOGFILE_LEVEL'        => 'Loglevel',
    'VM_ADMIN_CFG_LOGFILE_LEVEL_EXPLAIN' => 'Logboodschappen boven deze drempel worden genegeerd.',
    ...
    'VM_ADMIN_CFG_LOGFILE_FORMAT_EXPLAIN_EXTRA' => 'Logbestanden kunnen ieder van de navolgende velden bevatten: %{timestamp} %{ident} [%{priority}] [%{remoteip}] [%{username}] %{message} %{vmsessionid}.',
