...
$langvars = array (
	'CHARSET' => 'GB2312',
	'PHPSHOP_USER_LIST_LBL' => '会员列表',
	'PHPSHOP_USER_LIST_USERNAME' => '会员名称',
	'PHPSHOP_USER_LIST_FULL_NAME' => '姓名',
	'PHPSHOP_USER_LIST_GROUP' => '组',
	'PHPSHOP_USER_FORM_LBL' => '增加/更新会员信息',
	...
	'PHPSHOP_MODULE_LIST_PERMS' => '模块参数',
	...
	'PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE' => '仅用于目录',
	'PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE_EXPLAIN' => '如果你选择了这个，将会取消所有购物车功能。',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES' => '显示价格',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES_EXPLAIN' => '选择以显示价格。 如果使用了目录功能, 有些情况下可能不需要在页面上显示价格。',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX' => '实际税款',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX_EXPLAIN' => '这将决定零重量物品是否含税。 修改 ps_checkout.php->calc_order_taxable()以自定义。',
	'PHPSHOP_ADMIN_CFG_TAX_MODE' => '税金模式:',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_SHIP' => '基于购物者地址',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_VENDOR' => '基于销售者地址',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_EXPLAIN' => '这将决定了计算税金的时候采用何种税率: 
                                                这取决于销商者与顾客分别来自哪个国家。
                                                ',
	...
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE' => '计算税金/运费之前减去折扣?',
	'PHPSHOP_ADMIN_CFG_REVIEW' => '启用客户评价系统',
	'PHPSHOP_ADMIN_CFG_REVIEW_EXPLAIN' => '如果启用的话, 你将允许顾客 <strong>评价产品</strong> 以及 <strong>撰写评论</strong> 。 <br />
                                                                                这样顾客可以写下他们的体验，为别的顾客提供参考。 <br />',
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE_EXPLAIN' => '设定这个标记来决定计算税金/运费之前减去折扣还是之后再减去折扣。',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS' => '必须同意服务条款?',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_EXPLAIN' => '如果你想让你的顾客注册的时候同意服务条款，选择此项。',
	'PHPSHOP_ADMIN_CFG_CHECK_STOCK' => '检查存货?',
	'PHPSHOP_ADMIN_CFG_CHECK_STOCK_EXPLAIN' => '设置在用户将物品添加到购物车的时候，是否检查存货等级。
                                                                                          如果设置了，商场将不允许顾客添加超出存货级别的商品。',
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE' => '启用代理商程序?',
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE_EXPLAIN' => '如果你在商场后台设置代理商的话，这将会在商场前端启用代理商跟踪。',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT' => '订单邮件格式:',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_TEXT' => '文本邮件',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_HTML' => 'HTML邮件',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_EXPLAIN' => '这决定了你的订单确认邮件将以何种方式投递:<br />
                                                                                        <ul><li>简单的文本邮件</li>
                                                                                        <li>或者是带有图片的HTML邮件。</li></ul>',
	'PHPSHOP_ADMIN_CFG_FRONTENDAMDIN' => '允许非后台用户使用前端管理程序?',
	'PHPSHOP_ADMIN_CFG_FRONTENDAMDIN_EXPLAIN' => '这个设置项可以为那些无法访问后台管理程序(比如.Registered和Editor)的商场管理员启用前台管理。',
	...
	'PHPSHOP_ADMIN_CFG_HOMEPAGE_EXPLAIN' => '此页面在默认情况下会被加载',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE' => 'ERRORPAGE',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE_EXPLAIN' => '此页面在出错时会默认加载',
	'PHPSHOP_ADMIN_CFG_DEBUG' => '调试 ?',
	'PHPSHOP_ADMIN_CFG_DEBUG_EXPLAIN' => '调试?  	   	会打开调试的输出. 这将会把调试页面显示在每个正常页面的底部。此信息在商场调试阶段非常有用。',
	'PHPSHOP_ADMIN_CFG_FLYPAGE' => '商品介绍',
	'PHPSHOP_ADMIN_CFG_FLYPAGE_EXPLAIN' => '这是显示商品详情的默认页面.',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE' => '目录模板',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN' => '这定义了在目录中显示商品默认的目录模板。<br />
                                                                                                      您可以修改已有模板以创建新模版文件。<br />
                                                                                                      (位于<strong>COMPONENTPATH/html/templates/</strong> 目录下面，名称以“browse_”起始)',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW' => '每行中默认商品数目',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN' => '这里定义了每行中显示商品的数目 <br />
                                                                                                      例如，如果你设置为4,那么目录模板中就会在每列显示四个商品。',
	'PHPSHOP_ADMIN_CFG_NOIMAGEPAGE' => '“无图片”的图片',
	'PHPSHOP_ADMIN_CFG_NOIMAGEPAGE_EXPLAIN' => '在商品无图片可用时，显示此图片。',
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION' => '显示脚标“powered by mambo-phpShop” ?',
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN' => '显示一个powered-by-mambo-phpShop的脚标图片。',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD' => '使单独配置的运输者与运费的标准送货模块。<strong>推荐 !</strong>',
	...
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_DISABLE' => '取消送货模块选择。',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR' => '启用结帐条',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR_EXPLAIN' => '如果你想在顾客结账过程中显示结帐进度条(显示1-2-3-4的图片进度条)，选择此项。',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS' => '显示您商店的结帐进度条',
	'PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS' => '启用下载',
	'PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS_EXPLAIN' => '选择此项会启用下载功能。适用于销售可下载商品的情况。',
