...
var toolbar = {
	...
	_delete : function()
	{
		...
		else
		{
			...
			if(answer)
			{
				var url = site_url("admin/advert/delete");
				var array_id = [];
	...
	_publish : function()
	{
		...
		else
		{
			...
			if(answer)
			{
				var url = site_url("admin/advert/update");
				var array_id = [];
    ...
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <div id="wrapper" class="panel">    
        	<form action="<?php echo site_url("admin/advert/manage");?>" method="post" id="adminForm">		    	
            ...
            <div class="panel_left">
                <div class="panel_right">
				    ...
				    <!-- ########################## TOOLBAR ########################## -->
				    <div class="toolbar">
				    	<button class="positive" type="button" onclick="toolbar._insert('<?php echo site_url('admin/advert/create');?>')"><img src="<?php echo theme_url('styles/default/images/icons/insert_row.png')?>"/><br/><?php echo lang('layout_toolbar_insert') ?></button>
				...
				<table class="listing" id="listing">
			        ...
			        <?php foreach( $data as $k => $item ):?>
				        <tr>
				        	...
				        	<td style="text-align: left; padding-left:5px;"><a href="<?php echo site_url('admin/advert/manage_advert/' . $item['id'])?>"><?php echo $item['name']?></a></td>
				            ...
				            <td>
				                <a href="<?php echo site_url('admin/advert/edit/' . $item['id'])?>" class="icon edit" rel="<?php echo $item['id']?>"></a>
				            </td>
				        </tr>
			        <?php endforeach;?>
			        <?php endif;?>
