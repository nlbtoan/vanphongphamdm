...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open("admin/advert/create");?>
						...
						<div class="panel_right">
							<table class="editing">
								<tr>
				            		...
				            		<td>
				            			<input type="text" size="30" name="name" value="<?php if ( !empty($restore_data) ) echo $restore_data['alias']; ?>"></input>
				            		</td>
				            	</tr>
				            	<tr>
				            		<th><?php echo lang('alias') ?>: </th>
				            		<td>
				            			<input type="text" size="30" name="alias" value="<?php if ( !empty($restore_data) ) echo $restore_data['alias']; ?>"></input>
				            		</td>
				            	</tr>
				            	<tr>
				            		<th>Mở  : </th>
