...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open("admin/advert/create_advert");?>
						...
						<div class="panel_right">
							<table class="editing">
								<tr>
				            		...
				            		<td>
				            			<input type="text" size="30" name="adv_text" value="<?php if ( !empty($restore_data) ) echo $restore_data['adv_text']; ?>"></input>
				            		</td>
				            	</tr>
				            	<tr>
				            		<th>Link: </th>
				            		<td>
				            			<input type="text" size="30" name="link" value="<?php if ( !empty($restore_data) ) echo $restore_data['link']; ?>"></input>
				            		</td>
				            	</tr>
				            	<tr>
				            		<th><?php echo lang('image') ?>: </th>
				            		<td>
				            			<input type="text" size="50" name="image" value="<?php if ( !empty($restore_data) ) echo $restore_data['image']; ?>"></input>
