				...
				<table class="listing" id="listing">
					...
					<?php for ($i=0; $i < count($data); $i++ ): ?>
						<tr>
							...
							<td> <a href="<?php echo site_url('admin/tour/edit_book/' . $data[$i]['id'])?>" class="icon menu pad_left"  style="white-space:nowrap; overflow:hidden; width:470px; <?php if(!$data[$i]['is_read']) echo 'font-weight:bold;'; ?>" title="<?php echo lang('action_see_and_edit');?>"><?php echo date('h:i:s - d/m/Y', $data[$i]['date'])?></a></td>
							...
							<td> <a href="<?php echo site_url('admin/tour/edit_book/' . $data[$i]['id'])?>" class="icon edit" rel="<?php echo $data[$i]['id']?>" title="<?php echo lang('action_edit');?>"></a></td>
						</tr>
					<?php endfor;?>
					<?php endif;?>
			    </tbody>
