...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open("admin/menu/edit_menu_item/" . $info['id']);?>
					...
					<fieldset class="element_<?php echo $item_lang['abbr']?>">
						...
						<table class="editing">
							<tr>
			            		<th>Tên menu : </th>
			            		<td>
			            			<input type="text" size="26" maxlength="20" name="<?php echo $item_lang['abbr']?>_namemenu" value="<?php echo $info[$item_lang['abbr'].'_title']?>">
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Tên mã : </th>
					...
					<fieldset>
						...
						<table class="editing">
			            	...
			            	<tr>
			            		<th>Link : </th>
			            		<td>
			            			<input type="text" size="50" maxlength="20" value="/<?php echo $info['link']?>" readonly="readonly">
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Mở theo : </th>
			            	...
			            	<tr>
			            		...
			            		<td>
			            			<select style="width:107px" class="select_group_menu" name="group_id">
			            				...
			            				<option <?php echo ($info['menu_group_id'] == $item['id']) ? 'selected="selected"' : ""; ?> value="<?php echo $item['id']?>"><?php echo $item['name']?></option>
			            				<?php endforeach;?>
			            			</select> <-- Chọn group menu <br/>
			            			<select size="10" style="margin-top:5px; min-width:107px" name="parent" class="select_parent_menu">
			            				<?php echo menu_combobox($group_id, $current_lang, $info['parent'], $info['id'])?>
			            			</select>
			            		</td>
			            	</tr>
			            	<tr>
