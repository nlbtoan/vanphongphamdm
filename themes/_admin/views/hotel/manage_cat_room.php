...
var toolbar = {
	...
	_delete : function()
	{
		...
		else
		{
			...
			if(answer)
			{
				var url = site_url("admin/hotel/delete_cat_room");
				var array_id = [];
	...
	_publish : function()
	{
		...
		else
		{
			...
			if(answer)
			{
				var url = site_url("admin/hotel/update_cat_room");
				var array_id = [];
    ...
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <div id="wrapper" class="panel">
        	<form action="<?php echo site_url("admin/hotel/manage_cat_room");?>" method="post" id="adminForm">        	
            ...
            <div class="panel_left">
                <div class="panel_right">
				    ...
				    <p class="float_l">
				        <span class="large"><?php echo lang('title_manage_cat_room') ?></span><br />
				    ...
				    <!-- ########################## TOOLBAR ########################## -->
				    <div class="toolbar">
				    	<button class="positive" type="button" title="<?php echo lang('action_add');?>"  onclick="toolbar._insert('<?php echo site_url('admin/hotel/create_cat_room');?>')"><img src="<?php echo theme_url('styles/default/images/icons/insert_row.png')?>"/><br/><?php echo lang('layout_toolbar_insert') ?></button>
				...
				<table class="listing" id="listing">
			        ...
			        <tr>
			            ...
			            <th><?php echo lang('table_th_name_cat_room') ?></th>
					...
					<?php for ($i=0; $i < count($data); $i++ ): ?>
						<tr>
							...
							<td> <a href="<?php echo site_url('admin/hotel/edit_cat_room/' . $data[$i]['id'])?>" class="icon menu pad_left"  style="white-space:nowrap; overflow:hidden; width:480px;" title="<?php echo lang('action_see_and_edit');?>"><?php echo $data[$i]['name']?><span style="color:#777;"> - <?php echo date('d/m/Y', $data[$i]['date'])?></span></a></td>
							...
							<td> <a href="<?php echo site_url('admin/hotel/edit_cat_room/' . $data[$i]['id'])?>" class="icon edit" rel="<?php echo $data[$i]['id']?>" title="<?php echo lang('action_edit');?>"></a></td>
						</tr>
					<?php endfor;?>
					<?php endif;?>
			    </tbody>
