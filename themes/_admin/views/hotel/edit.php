...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open_multipart("admin/hotel/edit/".$restore_data['id']);?>
					...
					<fieldset class="element_<?php echo $item_lang['abbr']?>">
						...
						<table class="editing">
			            	...
			            	<tr>
			            		...
			            		<td>
			            			<input type="text" size="50" name="<?php echo $item_lang['abbr']?>_address" value="<?php if ( !empty($restore_data) ) echo $restore_data[$item_lang['abbr'].'_address']; ?>" />
			            		</td>
			            	</tr>
			            	<tr>
			            		<th><?php echo lang('short_introduce');?>: </th>
			            		<td>
			            			<textarea cols="50" name="<?php echo $item_lang['abbr']?>_short_introduce"><?php if ( !empty($restore_data) ) echo $restore_data[$item_lang['abbr'].'_short_introduce']; ?></textarea>
			            		</td>
			            	</tr>
			            	<tr>
			            		<th><?php echo lang('full_introduce');?>: </th>
			            		<td>
			            			<textarea cols="50" name="<?php echo $item_lang['abbr']?>_full_introduce"><?php if ( !empty($restore_data) ) echo $restore_data[$item_lang['abbr'].'_full_introduce']; ?></textarea>
			            		</td>
			            	</tr>
		            	</table>
					</fieldset>
					...
					<fieldset>
						...
						<table class="editing">
			            	...
			            	<tr>
			            		...
			            		<td> 
			            			<?php if ( !empty($restore_data) ){?>
				            			<?php echo form_radio(array('checked' => $restore_data['level'] == "1" ? 'checked':'', 'name' => 'level', 'value' => '1')); ?> 1
				            			<?php echo form_radio(array('checked' => $restore_data['level'] == "2" ? 'checked':'', 'name' => 'level', 'value' => '2')); ?> 2
				            			<?php echo form_radio(array('checked' => $restore_data['level'] == "3" ? 'checked':'', 'name' => 'level', 'value' => '3')); ?> 3
				            			<?php echo form_radio(array('checked' => $restore_data['level'] == "4" ? 'checked':'', 'name' => 'level', 'value' => '4')); ?> 4
				            			<?php echo form_radio(array('checked' => $restore_data['level'] == "5" ? 'checked':'', 'name' => 'level', 'value' => '5')); ?> 5
			            			<?php } else {?>
			            				<?php echo form_radio(array('name' => 'level', 'value' => '1', 'checked' => 'checked')); ?> 1
				            			<?php echo form_radio(array('name' => 'level', 'value' => '2')); ?> 2
				            			<?php echo form_radio(array('name' => 'level', 'value' => '3')); ?> 3
				            			<?php echo form_radio(array('name' => 'level', 'value' => '4')); ?> 4
				            			<?php echo form_radio(array('name' => 'level', 'value' => '5')); ?> 5
			            			<?php }?>
			            		</td>
			            	</tr>
			            	<tr>
			            		...
			            		<td> 
			            			<input type="text" size="50" name="web" value="<?php if ( !empty($restore_data) ) echo $restore_data['web']; ?>" />
			            		</td>
			            	</tr>
			            	<tr>
