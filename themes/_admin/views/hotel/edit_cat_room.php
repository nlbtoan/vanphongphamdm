...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open_multipart("admin/hotel/edit_cat_room/".$restore_data['id']);?>
        <div id="wrapper" class="panel">
            <div class="panel_top"><div></div></div>            
            <div class="panel_left">
                <div class="panel_right">
                	<!-- ########################## ICON & BREADCRUMB ########################## --> 
				    <p class="float_l"><img src="<?php echo theme_url('styles/default/images/icons/user.gif') ?>"  title="<?php echo lang('edit_cat_room');?>"/></p>					
				    <p class="float_l">
				        <span class="large"><?php echo lang('edit_cat_room');?></span><br />
				...
				<!-- ########################## CONTENT ########################## -->
					...
					<fieldset class="element_<?php echo $item_lang['abbr']?>">
						...
						<table class="editing">
			            	<tr>
			            		<th><?php echo lang('name_cat_room');?>: </th>
			            		<td>
