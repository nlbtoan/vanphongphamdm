...
<body>	
    <div id="container">
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open("admin/flight/edit_flight/".$info['id']);?>
					...
					<fieldset>
						...
						<table class="editing">
			            	...
			            	<tr>
			            		...
			            		<td>
			            			<input type="text" style="width:300px" value="<?php echo $info['flight_code'];?>" name="flight_code"></input>
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Thời gian đi  : </th>
			            		<td>
			            			<input type="text" style="width:300px" value="<?php echo $info['time_departure'];?>" name="time_departure"></input>
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Thời gian đến : </th>
			            		<td>
			            			<input type="text" style="width:300px" value="<?php echo $info['time_arrival'];?>" name="time_arrival"></input>
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>chuyến bay : </th>
			            		<td>
				            		<select name="is_go">
				            			<?php if($info['is_go'] == 0):?>
				            			<option value="0" selected="selected">Đi</option>
				            			<option value="1">Đến</option>
				            			<?php else:?>
				            			<option value="0">Đi</option>
				            			<option value="1" selected="selected">Đến</option>
				            			<?php endif;?>
				            		</select>
			            		</td>
			            	</tr>
