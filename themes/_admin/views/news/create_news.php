...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open("admin/news/create_news");?>
					...
					<fieldset class="element_<?php echo $item_lang['abbr']?>">
						...
						<table class="editing">
							<tr>
			            		<th>Tiêu đề : </th>
			            		<td>
			            			<input type="text" size="50" name="<?php echo $item_lang['abbr']?>_title" value="<?php if(isset($restore_data[$item_lang['abbr'].'_title'])) echo $restore_data[$item_lang['abbr'].'_title'];?>">
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Tên mã : </th>
			            		<td>
			            			<input style="float:left;" type="text" size="37" name="<?php echo $item_lang['abbr']?>_alias" value="<?php if(isset($restore_data[$item_lang['abbr'].'_alias'])) echo $restore_data[$item_lang['abbr'].'_alias'];?>">
			            	...
			            	<tr>
			            		...
			            		<td>
			            			<textarea style="width:547px;" name="<?php echo $item_lang['abbr']?>_summary"><?php if ( !empty($restore_data) ) echo $restore_data[$item_lang['abbr'].'_summary']; ?></textarea>
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Nội dung : </th>
			            		<td>
			            			<textarea style="width:547px; height:350px;" name="<?php echo $item_lang['abbr']?>_content"><?php if ( !empty($restore_data) ) echo $restore_data[$item_lang['abbr'].'_content']; ?></textarea>
			            		</td>
			            	</tr>
		            	</table>
					</fieldset>
			            	...
			            	<tr>
			            		...
			            		<td>
			            			<select size="10" style="min-width:107px" name="cat_id">
			            				<?php echo category_combobox($current_lang, $current_cat, FALSE, 0, "", FALSE); ?>
			            			</select>
			            		</td>
			            	</tr>
			            	<tr>
		            			<th>Hình ảnh : </th>
			            		<td>
			            			<input type="text" size="50" value="" name="image" >
