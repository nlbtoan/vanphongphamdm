...
<div class="title_page">								
	...
	<table class="table_info" cellspacing="0" cellpadding="4" align="center" width="715" style="margin: 12px  0 20px 45px;">
                <col width="130"/>
		<tr>
		 ...
		 <tr>
			<td align="left" valign="top"><?php echo lang('destination')?>:</td>
