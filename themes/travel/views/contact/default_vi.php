...
<div class="contact" style="margin:0 0 30px 21px;">
	...
	<div class="contact_address">
		<span class="marker"><img src="<?php echo theme_url('styles/default/images/con_address.png');?>" alt="Địa chỉ: "  /></span>
		Địa chỉ: 14 Trần Hưng Đạo, Dương Đông, Phú Quốc - Kiên Giang 
		<br />
		<br />
    	<span class="marker"><img src="<?php echo theme_url('styles/default/images/con_tel.png');?>" alt="Điện thoại: "  /></span>
