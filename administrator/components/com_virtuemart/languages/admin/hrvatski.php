...
$langvars = array (
	...
	'PHPSHOP_USER_LIST_USERNAME' => 'Korisnièko Ime',
	'PHPSHOP_USER_LIST_FULL_NAME' => 'Puno Ime',
	'PHPSHOP_USER_LIST_GROUP' => 'Grupa',
	'PHPSHOP_USER_FORM_LBL' => 'Dodavanje/Ureðivanje informacija o korisniku',
	...
	'PHPSHOP_STATE_LIST_ADD' => 'Dodavanje/Ureðivanje Regije',
	...
	'PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE_EXPLAIN' => 'Ovime se onemoguæuje funkcionalnost košarice.',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES' => 'Prikazati cijene',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES_EXPLAIN' => 'Iskljuèite ovo ako želite koristiti katalog funkcionalnost - bez prikazivanja cijena.',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX' => 'Virtualni Porez',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX_EXPLAIN' => 'Želite li uraèunati porez na proizvode èija je težina nula. Ovo možete prilagoditi u ps_checkout.php->calc_order_taxable().',
	'PHPSHOP_ADMIN_CFG_TAX_MODE' => 'Porezna stopa:',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_SHIP' => 'Bazirano na adresi kupca',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_VENDOR' => 'Bazirano na adresi duæana',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_EXPLAIN' => 'Ovdje odreðujete po kojoj poreznoj stopi se izraèunava porez:<br />
                                                <ul><li>porez države iz koje je kupac</li><br/>
                                                <li>porez države iz koje je vlasnik duæana.</li></ul>',
	'PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE' => 'Omoguæiti višestruke porezne stope?',
	'PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE_EXPLAIN' => 'Oznaèite ovo ako imate razlièite porezne stope za razlièite proizvode (npr. 7% za knjige i hranu, 16% za ostale stvari)',
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE' => 'Odbiti popuste prije uraèunavanja poreza/dostave?',
	'PHPSHOP_ADMIN_CFG_REVIEW' => 'Omoguæiti recenziranje/ocjenjivanje proizvoda',
	'PHPSHOP_ADMIN_CFG_REVIEW_EXPLAIN' => 'Ako je ukljuèeno, kupci mogu <strong>ocjenjivati proizvode</strong> i napisati <strong>svoje mišljenje</strong> o njima. <br />Tako kupci mogu svoje mišljenje o proizvodu podijeliti s drugim (potencijalnim) kupcima.<br />',
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE_EXPLAIN' => 'Ako je ukljuèeno, odreðuje da se popust odbija od ukupnog iznosa <b>PRIJE</b> uraèunavanja poreza i pristojbe za dostavu.',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS' => 'Obavezni pristanak na uvjete korištenja',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_EXPLAIN' => 'Oznaèite ako želite da kupac mora pristati na uvjete korištenja prilikom registracije.',
	...
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE' => 'Suradnièki program',
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE_EXPLAIN' => 'Ovo omoguæava praæenje suradnika u shop-frontendu. Omoguæite ako ste u backendu dodali suradnike.',
	...
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_EXPLAIN' => 'Ovo odreðuje format emaila s detaljima o narudžbi:<br />
	...
	'PHPSHOP_ADMIN_CFG_FRONTENDAMDIN_EXPLAIN' => 'Ovime možete omoguæiti Frontend Administriranje korisnicima koji su administratori duæana, ali ne mogu pristupiti Joomla Administraciji (npr. Registriran / Urednik).',
	...
	'PHPSHOP_ADMIN_CFG_HOMEPAGE_EXPLAIN' => 'Ovo je poèetna stranica duæana.',
	...
	'PHPSHOP_ADMIN_CFG_DEBUG_EXPLAIN' => 'DEBUG?	Ukljuèuje debug output. Zbog ovoga se DEBUGPAGE pojavljuje na dnu svake stranice. Korisno tijekom perioda razvoja jer prikazuje sadržaj košarice, vrijednosti polja u obrascu i sl.',
	...
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN' => 'Ovo definira primarni predložak kategorije za prikaz proizvoda u kategoriji.<br />Možete napraviti nove predloške prilagodbom veæ postojeæih <br />(koji se nalaze u direktoriju <strong>PUTANJA_KOMPONENTE/html/templates/</strong> i poèinju sa browse_)',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW' => 'Standardni broj proizvoda u retku.',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN' => 'Ovo odreðuje broj proizvoda u retku. <br />Primjer: Ako ga postavite na 4, Predložak kategorije æe prikazati 4 proizvoda u svakom retku',
	...
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN' => 'Prikazuje powered-by-VirtueMart logo na dnu duæana.',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD' => 'Primarni Dostavni modul sa individualno konfiguriranim dostavljaèima i transportnim troškovima. <strong>PREPORUÈENO !</strong>',
	...
	'PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS' => 'Status narudžbe koji omoguæava download',
	...
	'PHPSHOP_ADMIN_CFG_ORDER_DISABLE_DOWNLOADS' => 'Status narudžbe koji onemoguæava download',
	'PHPSHOP_ADMIN_CFG_ORDER_DISABLE_DOWNLOADS_EXPLAIN' => 'Odaberite koji status mora imati narudžba da bi se kupcu onemoguæio download.',
	'PHPSHOP_ADMIN_CFG_DOWNLOADROOT' => 'DOWNLOADROOT',
	'PHPSHOP_ADMIN_CFG_DOWNLOADROOT_EXPLAIN' => 'Fizièka putanja do datoteka za download.<br>
	...
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_MAX_EXPLAIN' => 'Odreðuje maksimalni broj dozvoljenih downloada za jednu narudžbu.',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE' => 'Download je Istekao',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE_EXPLAIN' => 'Odreðuje vremenski raspon <strong>u sekundama</strong> u kojemu je kupcima omoguæen download.
  Ovaj raspon poèinje prvim downloadom! Kad istekne vrijeme Download-ID se deaktivira.<br />Napomena: 86400sek=24sata.',
	...
	'PHPSHOP_COUPONS_ENABLE' => 'Ukljuèi Korištenje Kupona',
	'PHPSHOP_COUPONS_ENABLE_EXPLAIN' => 'Ako ukljuèite upotrebu kupona, dopustit æete kupcima da upišu brojeve kupona kako bi ostvarili popust na kupnju.',
	'PHPSHOP_ADMIN_CFG_PDF_BUTTON' => 'PDF - Dugme',
	'PHPSHOP_ADMIN_CFG_PDF_BUTTON_EXPLAIN' => 'PDF - Dugme u Duæanu',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER' => 'Uvjeti korištenja kod SVAKE NARUDŽBE',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_ONORDER_EXPLAIN' => 'Oznaèite ako želite da kupac mora pristati na uvjete korištenja prilikom SVAKE NARUDŽBE.',
	'PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS' => 'Prikazati proizvode kojih nema na zalihama',
	'PHPSHOP_ADMIN_CFG_SHOW_OUT_OF_STOCK_PRODUCTS_EXPLAIN' => 'Kada je omoguæeno, proizvodi kojih nema na zalihama su ipak prikazani. Inaèe su takvi proizvodi skriveni.',
	'PHPSHOP_ADMIN_CFG_SHOP_OFFLINE' => 'Duæan je Neaktivan',
	...
	'PHPSHOP_ADMIN_CFG_NAV_AT_TOP_TIP' => 'Možete ukljuèiti ili iskljuèiti prikazivanje Navigacijske Trake na vrhu liste proizvoda.',
	...
	'PHPSHOP_ADMIN_CFG_DYNAMIC_THUMBNAIL_RESIZING' => 'Dinamièna promjena velièine miniSlika?',
	'PHPSHOP_ADMIN_CFG_DYNAMIC_THUMBNAIL_RESIZING_TIP' => 'Omoguæuje dinamiènu promjenu velièine slika. Znaèi da æe sve miniSlike biti one velièine koju navedete ispod.
	...
	'PHPSHOP_ADMIN_CFG_SHIPPING_NO_SELECTION' => 'Popunite bar jednu kuæicu u Konfiguraciji Dostave!',
	...
	'PHPSHOP_ADMIN_CFG_PRICE_ACCESS_LEVEL_TIP' => 'Èlanovi odabrane grupe i svih grupa iznad mogu vidjeti cijene proizvoda.',
	'PHPSHOP_ADMIN_CFG_PRICE_SHOW_INCLUDINGTAX' => 'Prikazati (ukljuèujuæi XX% poreza)',
	'PHPSHOP_ADMIN_CFG_PRICE_SHOW_INCLUDINGTAX_TIP' => 'Kada je ovo ukljuèeno, kupci æe vidjeti tekst "(ukljuèujuæi XX% poreza)" uz cijene koje su prikazane s ukljuèenim porezom.',
