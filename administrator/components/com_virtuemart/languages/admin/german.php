...
$langvars = array (
	...
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_EXPLAIN' => 'Falls aktiviert, können sich Kunden nur im Shop registrieren, wenn Sie vorher den Geschäftsbedingungen zustimmen.',
	...
	'PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS_EXPLAIN' => 'Wählen Sie den Bestellstatus aus, bei dem der Kunde über den Download per e-mail benachrichtigt wird.',
	...
	'PHPSHOP_ADMIN_CFG_DOWNLOADROOT_EXPLAIN' => 'Das physikalische Verzeichnis (keine URL!) zu den Dateien, die Kunden per ID herunterladen können (Schrägstrich am Ende!)<br>
  ...
  Die Zeitspanne läuft ab dem ersten Download. Ist diese abgelaufen, wird die Download-ID deaktiviert.<br />Hinweis : 86400s=24h, 43%s=5d.',
	...
	'PHPSHOP_COUPONS_ENABLE_EXPLAIN' => 'Wird die Gutschein-Benutzung aktiviert, wird es dem Kunden erlaubt, während des Bestellvorgangs einen Gutschein-Code einzugeben.',
	...
	'PHPSHOP_ADMIN_CFG_NAV_AT_TOP_TIP' => 'Soll über der Auflistung von Produkten im Frontend eine Seitennavigation auch ÜBER der Liste angezeigt werden?',
...
<strong>Preis: $xx.xx</strong>',
	...
	'VM_FIELDMANAGER_PUBLISHED' => 'Veröffentlicht',
	...
	'VM_USERFIELD_FORM_LBL' => 'Hinzufügen / Ändern von Nutzerfeldern',
	'VM_BROWSE_ORDERBY_DEFAULT_FIELD_LBL' => 'standardmäßige Produktsortierung',
	'VM_BROWSE_ORDERBY_DEFAULT_FIELD_LBL_TIP' => 'Legt fest, welches Kriterium für die Sortierung von Produkten auf der Übersichtsseite verwendet wird.',
	'VM_BROWSE_ORDERBY_FIELDS_LBL' => 'Verfügbare "Sortiere-nach" Felder',
	...
	'VM_ADMIN_CFG_REVIEW_MAXIMUM_COMMENT_LENGTH' => 'Maximallänge für die Rezension',
	...
	'VM_ADMIN_SHOW_EMAILFRIEND' => 'Anzeigen der Verknüpfung "Einem Freund empfehlen"?',
	'VM_ADMIN_SHOW_EMAILFRIEND_TIP' => 'Falls aktiviert, wird eine kleine Verknüpfung angezeigt, die es Kunden ermöglicht, Produkte an Bekannte per E-Mail zu empfehlen.',
	'VM_ADMIN_SHOW_PRINTICON' => 'Anzeigen der Verknüpfung "Ausdrucken"?',
	'VM_ADMIN_SHOW_PRINTICON_TIP' => 'Falls aktiviert, wird eine kleine Verknüpfung angezeigt, die es Kunden ermöglicht, die aktuelle Seite auszudrucken.',
	'VM_REVIEWS_AUTOPUBLISH' => 'Rezensionen automatisch veröffentlichen?',
	'VM_REVIEWS_AUTOPUBLISH_TIP' => 'Falls aktiviert, werden Kundenrezensionen automatisch veröffentlicht, sobald sie eingesendet wurden. Ansonsten müssen Rezensionen manuell freigegeben werden.',
...
Im Zweifelsfall leerlassen.</strong> Dieser Wert wird verwendet, um von dem Shopserver ins Internet kommunizieren zu können (z.B. um Versandkosten live abzufragen).',
	...
	'VM_ADMIN_CFG_PROXY_PORT_TIP' => 'Der Port, der für die Kommunikation mit dem Proxy Server genutzt werden soll (meistens <b>80</b> oder <b>8080</b>).',
	...
	'VM_ADMIN_ONCHECKOUT_SHOW_LEGALINFO' => 'Verbraucherhinweis zum Widerrufs- oder Rückgaberecht anzeigen?',
	...
	'VM_ADMIN_ONCHECKOUT_LEGALINFO_SHORTTEXT' => 'Widerrufs- und Rückgabebelehrung (Kurzversion).',
	'VM_ADMIN_ONCHECKOUT_LEGALINFO_SHORTTEXT_TIP' => 'Dieser Text informiert den Kunden über dessen Widerrufs- und Rückgaberecht (wird über der Schaltfläche "Bestellung absenden" auf der letzten Seite des Bestellvorgangs angezeigt).',
	'VM_ADMIN_ONCHECKOUT_LEGALINFO_LINK' => 'Ausführliche Version der Widerrufs- und Rückgabebelehrung (Link zu einem Artikel).',
	'VM_ADMIN_ONCHECKOUT_LEGALINFO_LINK_TIP' => 'Hier kann ein Artikel ausgewählt werden, der den Kunden ausführlich über dessen Widerrufs- und Rückgaberecht informiert.
Bitte hier einen Artikel auswählen!',
	'VM_SELECT_THEME' => 'Wählen Sie das Thema/Stil für den Shop',
	'VM_SELECT_THEME_TIP' => 'Themen erlauben das Anpassen und Verändern des Seitenlayouts für den Shop.',
	...
	'VM_CFG_CURRENCY_MODULE' => 'Wählen Sie ein Währungsumrechungsmodul aus',
	...
	'VM_USERGROUP_FORM_LBL' => 'Hinzufügen/Ändern einer Nutzergruppe',
	'VM_USERGROUP_NAME' => 'Name der Nutzergruppe',
	'VM_USERGROUP_LEVEL' => 'Berechtigungsebene der Nutzergruppe',
	'VM_USERGROUP_LEVEL_TIP' => 'Wichtig! Ein größerer Wert bedeutet <b>weniger</b> Berechtigungen als Gruppen mit niedrigerem Wert. Die <b>admin</b> Gruppe ist <em>level 0</em>, storeadmin ist level 250, users ist level 500.',
