...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open("admin/news/create_category");?>
					...
					<fieldset class="element_<?php echo $item_lang['abbr']?>">
						...
						<table class="editing">
							<tr>
			            		<th>Tên danh mục : </th>
			            		<td>
			            			<input type="text" size="26" maxlength="20" name="<?php echo $item_lang['abbr']?>_name" value="<?php if(isset($restore_data[$item_lang['abbr'].'_name'])) echo $restore_data[$item_lang['abbr'].'_name'];?>">
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Tên mã : </th>
			            		<td>
			            			<input type="text" size="26" maxlength="20" name="<?php echo $item_lang['abbr']?>_alias" value="<?php if(isset($restore_data[$item_lang['abbr'].'_alias'])) echo $restore_data[$item_lang['abbr'].'_alias'];?>">
			            	...
			            	<tr>
			            		...
			            		<td>
			            			<select size="10" style="min-width:107px" name="parent">
			            				<?php echo category_combobox($current_lang); ?>
			            			</select>
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Thứ tự : </th>
			            		<td>
			            			Thứ tự mới mặc định là ví trí cuối cùng. Thứ tự có thể thay đổi sau khi được Thêm thành công.
			            		</td>
			            	</tr>
			            	<tr>
			            		<th>Mở  : </th>
