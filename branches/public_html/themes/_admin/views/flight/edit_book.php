...
$(document).ready(function(){
	...
	var event_remove = function(e){
		...
		/*if ( $('select[name*=sl_age] option[value=0]:selected').length < 1 ){
			...
			if ( $(this).attr('rel') != "" ){
				var url = site_url('admin/flight/delete_book_detail');
...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open("admin/flight/edit_book/".$restore_data['id'], 'id="frm_edit_book"');?>
            ...
            <div class="panel_left">
				...
				<!-- ########################## CONTENT ########################## -->
					<fieldset>
						...
						<a id="save_xsl" class="button" href="<?php echo site_url('admin/flight/xsl/'.$restore_data['id']);?>"><img src="<?php echo theme_url('styles/default/images/icons/xls.png')?>"/>Xuất file Exel</a>
						<div class="clear"></div>
						<table class="editing">
							<tr>
