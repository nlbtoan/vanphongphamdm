...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open_multipart("admin/tour/edit/".$restore_data['id']);?>
					...
					<fieldset>
						...
						<table class="editing">
							<tr>
			            		...
			            		<td>
			            			<select name="tour_cat_id" size="10" style="margin-top:5px; min-width:107px" class="select_parent_menu" autocomplete="off">
