...
$(document).ready(function(){
	...
	$(".check_alias").click(function() {
		...
		{
			var url = site_url("admin/tour/ajax_check_exits_alias");
...
<body>	
    <div id="container">    	   
       ...
       <!-- ########################## LEFT ########################## -->
        ...
        <!-- ########################## WRAPPER ########################## -->
        <?php echo form_open_multipart("admin/tour/create_cat");?>
        <div id="wrapper" class="panel">
            <div class="panel_top"><div></div></div>            
            <div class="panel_left">
                <div class="panel_right">
                	<!-- ########################## ICON & BREADCRUMB ########################## --> 
				    <p class="float_l"><img src="<?php echo theme_url('styles/default/images/icons/user.gif') ?>"  title="<?php echo lang('create_cat');?>"/></p>					
				    <p class="float_l">
				        <span class="large"><?php echo lang('create_cat');?></span><br />
							...
							<tr>
			            		...
			            		<td>
			            			<select size="10" style="margin-top:5px; min-width:107px" name="parent_id" class="select_parent_menu">
			            				<?php echo tour_combobox($current_lang)?>
			            			</select>
			            		</td>
			            	</tr>
							<tr>
