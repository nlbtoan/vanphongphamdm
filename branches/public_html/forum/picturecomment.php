	...
	if ($_POST['do'] == 'message')
	{
		...
		else
		{
			...
			else
			{
				...
				{
					$redirect_url_prefix = 'group.php?' . $vbulletin->session->vars['sessionurl'] . "do=picture&amp;groupid=$pictureinfo[groupid]&amp;attachmentid=$pictureinfo[attachmentid]";
				}
				else
				{
					$redirect_url_prefix = 'album.php?' . $vbulletin->session->vars['sessionurl'] . "albumid=$pictureinfo[albumid]&amp;attachmentid=$pictureinfo[attachmentid]";
				}
...
if ($_POST['do'] == 'deletemessage')
{
	...
	if ($pictureinfo['groupid'])
	{
		$vbulletin->url = 'group.php?' . $vbulletin->session->vars['sessionurl'] . "do=picture&amp;groupid=$pictureinfo[groupid]&amp;attachmentid=$pictureinfo[attachmentid]";
	}
	else
	{
