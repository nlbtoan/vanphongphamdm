...
// ###################### Start create ######################
	...
	public function create_array($ids)
	{
		...
		"user AS poster ON(poster.userid = visitormessage.postuserid) LEFT JOIN " . TABLE_PREFIX .
		"avatar AS avatar ON(avatar.avatarid = poster.avatarid) LEFT JOIN " . TABLE_PREFIX .
		"customavatar AS customavatar ON(customavatar.userid = poster.userid)" : "") . "
