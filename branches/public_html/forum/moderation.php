...
if ($_REQUEST['do'] == 'viewgms' OR $_REQUEST['do'] == 'viewdiscussions')
{
	...
	$order_selected = array(($descending ? 'desc' : 'asc') => 'selected="selected"');
	$sort_selected = array($sortfield => 'selected="selected"');
	$order_checked = array(($descending ? 'desc' : 'asc') => 'checked="checked"');
	$sort_checked = array($sortfield => 'checked="checked"');
	...
	$templater = vB_Template::create('moderation_filter');
		...
		$templater->register('perpage', $perpage);
		$templater->register('sort_title', true);
		$templater->register('order_selected', $order_selected);
		$templater->register('sort_selected', $sort_selected);
		$templater->register('order_checked', $order_checked);
		$templater->register('sort_checked', $sort_checked);
		$templater->register('type', $type);
	$moderation_filter = $templater->render();
