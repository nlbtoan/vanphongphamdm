...
*/
	...
	/**
	 * Comlumns search in meta table	 
	 */
	$config['search_columns']			   = array('first_name', 'last_name');	
	/**
	 ...
	 **/
	$config['message_start_delimiter'] = '<li>';
	
	/**
	 * Message End Delimiter
	 **/
	$config['message_end_delimiter'] = '</li>';
	
	/**
	 * Error Start Delimiter
	 **/
	$config['error_start_delimiter'] = '<li>';
	
	/**
	 * Error End Delimiter
	 **/
	$config['error_end_delimiter'] = '</li>';
